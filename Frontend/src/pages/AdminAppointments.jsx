...
const SalonAdminAppointments = () => {
  ...
  const [branches, setBranches] = useState([]); // Only need branches for list filter
        ...
        <div className="mb-8 flex flex-col sm:flex-row sm:items-center justify-between gap-4">
          ...
          <div className="flex flex-col sm:flex-row gap-3">
            <select
              ...
              className="px-4 py-3 rounded-xl text-sm font-semibold border-2 border-gray-200 bg-white text-gray-700 focus:outline-none focus:border-rose-500 shadow-sm"
            >
            ...
            <button
              ...
              className="px-6 py-3 bg-gradient-to-r from-rose-500 to-pink-500 hover:from-rose-600 hover:to-pink-600 text-white font-bold rounded-xl shadow-lg shadow-rose-500/30 transition-all flex items-center justify-center gap-2"
            >
