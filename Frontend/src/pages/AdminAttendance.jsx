...
const AdminAttendance = () => {
    ...
    const fetchAttendance = async () => {
        try {
            ...
            showToast(err.response?.data?.message || "Error fetching attendance", "error");
        } finally {
            setLoading(false);
        }
    };
            ...
            <main className="min-h-screen bg-white lg:ml-64 pt-16 lg:pt-8 px-4 sm:px-6 lg:px-8 pb-10">
                ...
                <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6 mb-8">
                    ...
                    <div className="bg-white rounded-2xl p-6 shadow-lg shadow-rose-500/5 border border-rose-100 hover:shadow-xl hover:shadow-rose-500/10 transition-all group">
                        ...
                        <h3 className="text-gray-600 text-sm font-medium mb-1">Total Staff</h3>
                ...
                {staffList.length === 0 && !loading ? (
                    <div className="flex flex-col items-center justify-center py-20">
                        ...
                        <p className="text-gray-600 mb-8 text-center max-w-md">
                            {selectedBranch !== "all"
                                ? "No staff members found for the selected branch."
                                : "No staff members found. Add staff first to track attendance."}
                        </p>
                    </div>
                ) : (
                    <div className="bg-white rounded-2xl shadow-lg border border-gray-100 overflow-hidden">
                        <div className="p-6 border-b border-gray-100 bg-gradient-to-r from-rose-50 to-pink-50">
                            ...
                            <p className="text-sm text-gray-600 mt-1">
                                ...
                                {selectedBranch !== "all" && ` in ${getBranchName(selectedBranch)}`}
                            </p>
                        </div>
                                ...
                                <tbody>
                                    {staffList.map((member) => (
                                        ...
                                        >
                                            ...
                                            <td className="px-6 py-4">
                                                <span
                                                    className={`px-3 py-1 rounded-full text-xs font-semibold border ${member.staffStatus === "active"
                                            ...
                                            <td className="px-6 py-4">
                                                <div className="flex items-center justify-center gap-2">
                                                    <button
                                                        ...
                                                        className={`px-4 py-2 rounded-lg text-sm font-semibold transition-all ${member.attendance === "present"
                                                    ...
                                                    <button
                                                        ...
                                                        disabled={markingId === member._id}
                                                        className={`px-4 py-2 rounded-lg text-sm font-semibold transition-all ${member.attendance === "absent"
                                ...
                                <div key={member._id} className="p-4">
                                    ...
                                    <div className="flex items-center gap-2">
                                        <button
                                            onClick={() => markAttendance(member._id, "present")}
                                            disabled={markingId === member._id}
                                            className={`flex-1 px-3 py-2.5 rounded-xl text-sm font-semibold transition-all ${member.attendance === "present"
                                                    ? "bg-green-500 text-white shadow-lg shadow-green-500/30"
                                                    : "bg-gray-100 text-gray-600 hover:bg-green-100 hover:text-green-700"
                                                } disabled:opacity-50`}
                                        >
                                        ...
                                        <button
                                            onClick={() => markAttendance(member._id, "absent")}
                                            disabled={markingId === member._id}
                                            className={`flex-1 px-3 py-2.5 rounded-xl text-sm font-semibold transition-all ${member.attendance === "absent"
                                                    ? "bg-red-500 text-white shadow-lg shadow-red-500/30"
                                                    : "bg-gray-100 text-gray-600 hover:bg-red-100 hover:text-red-700"
                                                } disabled:opacity-50`}
                                        >
