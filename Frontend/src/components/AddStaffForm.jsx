  ...
  return (
    <form onSubmit={onSubmit} className="max-h-[85vh] overflow-y-auto">
      ...
      <div className="p-6 space-y-6">
        ...
        <div>
          <h3 className="text-lg font-bold text-gray-900 mb-4 flex items-center gap-2">
            <i className="ri-briefcase-line text-rose-500"></i>
            Role & Assignment
          </h3>
      ...
      <div className="sticky bottom-0 bg-gray-50 px-6 py-4 flex flex-col sm:flex-row gap-3 border-t border-gray-200">
        ...
        <button
          type="submit"
          className="flex-1 px-6 py-3 rounded-xl bg-gradient-to-r from-rose-500 to-pink-500 text-white font-semibold shadow-lg shadow-rose-500/30 hover:shadow-xl hover:shadow-rose-500/40 hover:scale-105 transition-all flex items-center justify-center gap-2"
        >
          <i className="ri-user-add-line"></i>
          Add Staff Member
        </button>
